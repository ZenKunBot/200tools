...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-ZenKun~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "ZenKun" | lolcat
php tp.php
fi
...
then
clear
toilet -f standard -F gay "ZenKun" 
...
then
clear
toilet -f big -F gay "ZenKun " | lolcat
sleep 1
